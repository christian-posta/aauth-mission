...
# Supports optional --mission-description, --permission-action, --audit, --complete-mission.
#
#   AAUTH_MM_INSECURE_DEV=false uvicorn mm.http.app:app --host 127.0.0.1 --port 8000
#   ./scripts/hwk-mm-client.sh
#   ./scripts/hwk-mm-client.sh --base-url http://localhost:8000 --mission-description "# Demo" --audit
#
set -euo pipefail
